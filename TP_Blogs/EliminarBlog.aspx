<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarBlog.aspx.cs" Inherits="TP_Blogs.EliminarBlog" %>
    ...
    <form id="form1" runat="server" >
        <div style="height: 1041px; background-color:#5E59EE;" >
            ...
            <asp:Panel ID="Panel1" runat="server" Height="75px" style="margin-top: -40px" HorizontalAlign="Center" BackColor="#5E59EE">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="XX-Large" Font-Underline="True" ForeColor="Black" Text="ELIMINAR BLOGS" ></asp:Label>
                <br />
            </asp:Panel>
            <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
